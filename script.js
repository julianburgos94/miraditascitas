 ...
 */
const SHEETS_URL = 'https://script.google.com/macros/s/AKfycbxbVEMdcLTG61TADKlteQJTf5bzEvWN8P7M2Pw_9MkKqc7i_PYoAYnEHp2eTvKrSrJ4fg/exec';
...
async function guardarCitaEnSheets(cita) {
  ...
  const params = new URLSearchParams({
    ...
    hora:        cita.hora.trim()   // ← trim() para eliminar espacios accidentales
  });
